...
module.exports = {
	...
	, msg: function ( wire, val ) {
		switch ( wire ) {
		case "Ld":  if ( val === 1 ) { PullBus(true); my["_data_"] = my["_InputBuffer_"]; }				TurnOn( "ir_Ld"  );   Display( my["_data_"]); my["_Ld_"] = 1; break;
		case "Out": if ( val === 1 ) { my["_OutputBuffer_"] = my["_data_"]; PushBus(); }   TurnOn( "ir_Out" );   Display( my["_data_"]); break;
