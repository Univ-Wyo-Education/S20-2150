	...
	DCL is_halted is_fetch set_execute ins_end id_ALU_Ctl do_input do_output ir_decode_g2
...
// OpSkip[XXXX] --- OpSkipLt0, OpSkipEq0, OpSkipGt0: 3+3
    ORG        0b1_1000_000
    McJmp_6 id_result_Out id_decoder_Ctl_1    id_ir_Out ir_decode_g2  					set_execute id_Microcode_PC_Ld 		// Jumpt to bank 0 of microcode based on input fields. decoder_ctl = 0b10
